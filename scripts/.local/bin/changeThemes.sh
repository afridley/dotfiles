...
if [ $MONTH == 06 ]; then
  ...
  sed -i'' -e 's/"nightcity"/"gruvbox-material"/g' ~/dotfiles/lazyvim/.config/nvim/lua/plugins/core.lua
...
if [ $MONTH == 07 ]; then
  ...
  sed -i'' -e 's/"gruvbox-material"/"miramare"/g' ~/dotfiles/lazyvim/.config/nvim/lua/plugins/core.lua
